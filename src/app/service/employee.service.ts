...
getallbyType(){
  return this.http.get("http://localhost:8081/libredeman/allDemandByType")
}
getDemandeBymatricule(matricule :any){
  return this.http.get("http://localhost:8081/libredeman/getByMatricule/"+matricule)
}
...
getuserByMatricule(id:any): Observable<any> {
  return this.http.get<any>("http://localhost:8081/api/auth/getByMatricule/"+id);
}
...
updateDemandeRéffuser(id: any ,a:any ): Observable<any>{
  console.log(("umai"));

  return this.http.put<any>( "http://localhost:8081/libredeman/updateRefused/" +id,a);
  
}
updateChef(id: any ,a:any ): Observable<any>{
  console.log(("updateChef"));

  return this.http.put<any>( "http://localhost:8081/api/auth/updatechef/" +id,a);
